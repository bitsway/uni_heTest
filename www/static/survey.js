...
function submi_saved_req(i){
	...
	alert (url_submit = apipath+'syncSubmitData?cid='+localStorage.cid+'&cm_id='+localStorage.cm_id+'&cm_pass='+localStorage.cm_pass+'&synccode='+localStorage.synccode+'&route='+localStorage.selectedRoute+'&routeEx='+localStorage.routeException)
	alert ('&outlet='+localStorage.selectedOutlet+'&scheduleDate='+ localStorage.selected_date +'&outletEx='+localStorage.outletException+'&channel='+localStorage.outletChannel)
...
//}
//
//function upload_gift_confirm_saved(){
//	//Gift
//	var gift_data =  localStorage.gift_data_ready.replace("rdrd","");
//	var gift_array =  gift_data.split('fdfd');
//
